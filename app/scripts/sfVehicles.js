...
var locations = {
  "FirebaseHQ": [6.8632354, 79.9528196],
  "Caltrain": [6.8632354, 79.9528196]
};
...
var transitFirebaseRef = new Firebase("https://gayan-loction.firebaseio.com/")
...
geoQuery.on("key_entered", function(vehicleId, vehicleLocation) {
  ...
  transitFirebaseRef.child("identities").child(vehicleId).once("value", function(dataSnapshot) {
...
function createVehicleMarker(vehicle, vehicleColor) {
  var marker = new google.maps.Marker({
    //https://developers.google.com/chart/image/docs/gallery/dynamic_icons?csw=1#image-list
    icon: "https://chart.googleapis.com/chart?chst=d_bubble_icon_text_small&chld=" + "mobile" + "|bbT|" + vehicle.name + "|" + vehicleColor + "|eee",
